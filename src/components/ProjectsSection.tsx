...
const PROJECTS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Collaborated cross-functionally with product, content, and community teams.',
    ],
    img1: '/u2u-1.png',
    img2: '/u2u-2.png',
  ...
  },
  {
    ...
    bullets: [
      'Led end-to-end marketing strategy for a centralized exchange, focusing on scalable user acquisition and long-term retention.',
      'Designed and executed growth campaigns: referral programs, trading competitions, incentive mechanisms, and onboarding flows.',
      'Built and optimized user lifecycle journeys (activation → engagement → retention) through targeted campaigns and CRM flows.',
      'Developed frameworks to re-engage inactive users and improve retention across key segments.',
    ],
    img1: '/ssid-1.png',
    img2: '/ssid-2.png',
    logos: ['/logo-ssid.png'],
  },
  {
    ...
    bullets: [
      'Led a team of 3 to develop AI-assisted workflows across growth functions: social, SEO, partnerships, and AI Visibility Reports.',
      'Drove 15K+ installs, 1.5M+ prompts analyzed, and 1,200+ AI Visibility Reports within 2 months.',
      'Designed the Mention Voyage mechanism, Earn Dashboard UI, and marketing assets for campaigns.',
      'Managed KOL/influencer partnerships and executed multi-platform airdrop campaigns across X, Galxe, and Telegram.',
    ],
    img1: '/mention-5.png',
    img2: '/mention-2.png',
  ...
  },
  {
    ...
    bullets: [
      'Leveraged Claude Code to streamline collaboration between marketing and engineering teams via GitHub (issue tracking & PRs).',
      ...
      'Built automated on-chain data scraping pipelines with OpenClaw to detect whale activity and generate actionable product insights.',
      'Contributed to new product feature development bridging growth and engineering.',
    ],
    img1: null,
    img2: null,
    logos: ['/logo-lab3.png'],
